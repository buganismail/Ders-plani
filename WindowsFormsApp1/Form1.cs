/****************************************************************************
** 
**      Nesneye Dayalı Programlama Dersi için hazırlamış olduğum 
**      Uyku - Yemek - Diğer(eğlence vb.) gibi değişkenleri aldıktan 
**      sonra gün içindeki toplam boş vakti ve bu vakit içerisine 
**      sığdırabileceği ders adetini listeyen C# ile yazılmış bir programdır.
**
****************************************************************************/
